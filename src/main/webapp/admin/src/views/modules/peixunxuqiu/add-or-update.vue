<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="需求原因" prop="xuqiuyuanyin">
          <el-input v-model="ruleForm.xuqiuyuanyin" 
              placeholder="需求原因" clearable  :readonly="ro.xuqiuyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="需求原因" prop="xuqiuyuanyin">
              <el-input v-model="ruleForm.xuqiuyuanyin" 
                placeholder="需求原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="时间要求" prop="shijianyaoqiu">
          <el-input v-model="ruleForm.shijianyaoqiu" 
              placeholder="时间要求" clearable  :readonly="ro.shijianyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="时间要求" prop="shijianyaoqiu">
              <el-input v-model="ruleForm.shijianyaoqiu" 
                placeholder="时间要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主管账号" prop="zhuguanzhanghao">
          <el-input v-model="ruleForm.zhuguanzhanghao" 
              placeholder="主管账号" clearable  :readonly="ro.zhuguanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主管账号" prop="zhuguanzhanghao">
              <el-input v-model="ruleForm.zhuguanzhanghao" 
                placeholder="主管账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主管姓名" prop="zhuguanxingming">
          <el-input v-model="ruleForm.zhuguanxingming" 
              placeholder="主管姓名" clearable  :readonly="ro.zhuguanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主管姓名" prop="zhuguanxingming">
              <el-input v-model="ruleForm.zhuguanxingming" 
                placeholder="主管姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="需求内容" prop="xuqiuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xuqiuneirong" label="需求内容" prop="xuqiuneirong">
                    <span>{{ruleForm.xuqiuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          shijianyaoqiu: [
                { required: true, message: '时间要求不能为空', trigger: 'blur' },
          ],
          zhuguanzhanghao: [
          ],
          zhuguanxingming: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongshouji = true;
          ...
          if(o=='xuqiuyuanyin'){
            this.ruleForm.xuqiuyuanyin = obj[o];
	    this.ro.xuqiuyuanyin = true;
            continue;
          }
          if(o=='xuqiuneirong'){
	    ...
	    this.ro.xuqiuneirong = true;
          ...
          if(o=='shijianyaoqiu'){
            this.ruleForm.shijianyaoqiu = obj[o];
	    this.ro.shijianyaoqiu = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.yuangongshouji!=''&&json.yuangongshouji){
                this.ruleForm.yuangongshouji = json.yuangongshouji
	    		this.ro.yuangongshouji = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `peixunxuqiu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.peixunxuqiuCrossAddOrUpdateFlag = false;
						 this.parent.search();
