<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="主管性别" prop="zhuguanxingbie">
          <el-select :disabled="ro.zhuguanxingbie" v-model="ruleForm.zhuguanxingbie" placeholder="请选择主管性别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="主管性别" prop="zhuguanxingbie">
	      <el-input v-model="ruleForm.zhuguanxingbie"
                placeholder="主管性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主管手机" prop="zhuguanshouji">
          <el-input v-model="ruleForm.zhuguanshouji" 
              placeholder="主管手机" clearable  :readonly="ro.zhuguanshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主管手机" prop="zhuguanshouji">
              <el-input v-model="ruleForm.zhuguanshouji" 
                placeholder="主管手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
          ...
          if(o=='zhuguanxingbie'){
            this.ruleForm.zhuguanxingbie = obj[o];
	    this.ro.zhuguanxingbie = true;
            continue;
          }
          if(o=='zhuguanshouji'){
            this.ruleForm.zhuguanshouji = obj[o];
	    this.ro.zhuguanshouji = true;
            continue;
          }
        }
      }
