<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="计划类型" prop="jihualeixing">
          <el-input v-model="ruleForm.jihualeixing" 
              placeholder="计划类型" clearable  :readonly="ro.jihualeixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="计划类型" prop="jihualeixing">
              <el-input v-model="ruleForm.jihualeixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预算费用" prop="yusuanfeiyong">
          <el-input v-model="ruleForm.yusuanfeiyong" 
              placeholder="预算费用" clearable  :readonly="ro.yusuanfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预算费用" prop="yusuanfeiyong">
              <el-input v-model="ruleForm.yusuanfeiyong" 
                placeholder="预算费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="计划内容" prop="jihuaneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jihuaneirong" label="计划内容" prop="jihuaneirong">
                    <span v-html="ruleForm.jihuaneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jihualeixing = true;
          ...
          if(o=='yusuanfeiyong'){
            this.ruleForm.yusuanfeiyong = obj[o];
	    this.ro.yusuanfeiyong = true;
            continue;
          }
	...
	this.ruleForm.jihuaneirong = this.ruleForm.jihuaneirong.replace(reg,'../../../ssm35vlg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `peixunjihua/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.peixunjihuaCrossAddOrUpdateFlag = false;
						 this.parent.search();
