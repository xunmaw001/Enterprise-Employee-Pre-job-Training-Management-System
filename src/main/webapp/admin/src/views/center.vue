<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='bumenzhuguan'"  label="主管账号" prop="zhuguanzhanghao">
          <el-input v-model="ruleForm.zhuguanzhanghao" readonly              placeholder="主管账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='bumenzhuguan'"  label="主管姓名" prop="zhuguanxingming">
          <el-input v-model="ruleForm.zhuguanxingming"               placeholder="主管姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='bumenzhuguan'"  label="部门" prop="bumen">
          <el-select v-model="ruleForm.bumen"  placeholder="请选择部门">
            <el-option
                v-for="(item,index) in bumenzhuguanbumenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='bumenzhuguan'"  label="主管性别" prop="zhuguanxingbie">
          <el-select v-model="ruleForm.zhuguanxingbie"  placeholder="请选择主管性别">
            <el-option
                v-for="(item,index) in bumenzhuguanzhuguanxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='bumenzhuguan'"  label="主管手机" prop="zhuguanshouji">
          <el-input v-model="ruleForm.zhuguanshouji"               placeholder="主管手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="主管账号" prop="zhuguanzhanghao">
          <el-input v-model="ruleForm.zhuguanzhanghao" readonly              placeholder="主管账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="主管姓名" prop="zhuguanxingming">
          <el-input v-model="ruleForm.zhuguanxingming" readonly              placeholder="主管姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    return {
      ...
      flag: '',
      usersFlag: false,
      bumenzhuguanbumenOptions: [],
      bumenzhuguanzhuguanxingbieOptions: [],
  ...
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.bumenzhuguanbumenOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
    this.bumenzhuguanzhuguanxingbieOptions = "男,女".split(',')
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.zhuguanzhanghao)&& 'bumenzhuguan'==this.flag){
        this.$message.error('主管账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'bumenzhuguan'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if((!this.ruleForm.zhuguanxingming)&& 'bumenzhuguan'==this.flag){
        this.$message.error('主管姓名不能为空');
        return
      }
      if( 'bumenzhuguan' ==this.flag && this.ruleForm.zhuguanshouji&&(!isMobile(this.ruleForm.zhuguanshouji))){
