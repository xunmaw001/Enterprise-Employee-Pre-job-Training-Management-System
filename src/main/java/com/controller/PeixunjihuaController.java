...
public class PeixunjihuaController {
    ...
    public R page(@RequestParam Map<String, Object> params,PeixunjihuaEntity peixunjihua, 
		...
		if(tableName.equals("yuangong")) {
			peixunjihua.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("bumenzhuguan")) {
			peixunjihua.setZhuguanzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<PeixunjihuaEntity> wrapper = new EntityWrapper<PeixunjihuaEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = peixunjihuaService.selectCount(wrapper);
