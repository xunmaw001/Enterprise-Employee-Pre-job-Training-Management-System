...
public class YuangongController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuangongEntity yuangong, 
		...
		if(tableName.equals("yuangong")) {
			yuangong.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("bumenzhuguan")) {
			yuangong.setZhuguanzhanghao((String)request.getSession().getAttribute("username"));
		}
